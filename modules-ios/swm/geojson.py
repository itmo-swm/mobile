...
if platform == "ios":
    ...
    import kivy.garden
    kivy.garden.garden_app_dir = join(dirname(sys.modules['__main__'].__file__), "libs", "garden")
    print kivy.garden.garden_app_dir
from kivy.garden.mapview.mapview import CACHE_DIR
from kivy.garden.mapview import MapLayer
from kivy.garden.mapview.mapview.downloader import Downloader
